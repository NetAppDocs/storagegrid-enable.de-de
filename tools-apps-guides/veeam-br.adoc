...
image::veeam-bp/veeam_blk_sz.png[Ein Screenshot einer Computerbeschreibung wird automatisch generiert,320,375]
...
Bild::veeam-bp/s3_over_Rates.png[S3 Overview Rates]
