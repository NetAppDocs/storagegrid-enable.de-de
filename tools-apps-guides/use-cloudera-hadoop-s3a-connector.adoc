...
. Die  https://docs.cloudera.com/cdp-private-cloud-upgrade/latest/upgrade/topics/cdpdc-java-requirements.html["Cloudera Support-Matrix"^] auf die unterstützte JDK-Version prüfen.
