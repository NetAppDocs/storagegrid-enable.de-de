...
. link:bare-metal-storagegrid-license.html["Geben Sie die StorageGRID Lizenzinformationen an"]
. link:bare-metal-add-sites-storagegrid.html["Fügen Sie Sites zu StorageGRID hinzu"]
. link:bare-metal-grid-network-subnets-storagegrid.html["Subnetze für das Grid-Netzwerk angeben"]
. link:bare-metal-approve-grid-nodes-storagegrid.html["Ausstehende Grid-Nodes genehmigen"]
. link:bare-metal-ntp-server-storagegrid.html["Geben Sie die NTP-Serverinformationen an"]
. link:bare-metal-dns-server-storagegrid.html["Geben Sie die Serverinformationen des DNS-Systems an"]
. link:bare-metal-system-passwords-storagegrid.html["Geben Sie die Passwörter für das StorageGRID-System an"]
. link:bare-metal-review-config-complete-storagegrid-install.html["Überprüfung der Konfiguration und vollständige Installation"]
