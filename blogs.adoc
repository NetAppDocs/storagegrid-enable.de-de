...
* Februar 2 2024:  https://community.netapp.com/t5/Tech-ONTAP-Blogs/Announcing-the-StorageGRID-lakeFS-Solution-Brief/ba-p/451465["Wir stellen vor: Die StorageGRID + LakeFS Lösung im Überblick"^]
