...
Plattform-Services werden vom S3-Mandanten über die Mandanten-Manager-UI konfiguriert. Weitere Informationen finden Sie unter https://["Überlegungen bei der Verwendung von Plattform-Services"^].

Dieses Dokument dient als Ergänzung zum https://["StorageGRID 11.6 Mandantenleitfaden"^] Und enthält Schritt-für-Schritt-Anleitungen und Beispiele für die Endpunkt- und Bucket-Konfiguration für Suchintegrations-Services. Die hier enthaltene Anleitung zur Einrichtung von Amazon Web Services (AWS) oder lokalen Elasticsearch-Services dienen nur zu Test- oder Demonstrationszwecken.
...
*** Öffnen Sie eine Browserregisterkarte für https://["https://checkip.amazonaws.com"^] Um Ihre öffentliche IP zu finden.
+
[source, json]
----
{
...
* https://["Was sind Plattform-Services"^]
