...
.Schritte
. Wenn am neuen Standort ein neues Grid Netzwerk-Subnetz verwendet wirdlink:https://docs.netapp.com/us-en/storagegrid/expand/updating-subnets-for-grid-network.html["Fügen Sie das Subnetz der Subnetzliste des Netznetzes hinzu"^]
...
. Per SSH eine Verbindung zum Gerät herstellen und den Node mit dem Befehl 'shutdown -h now' herunterfahren.
